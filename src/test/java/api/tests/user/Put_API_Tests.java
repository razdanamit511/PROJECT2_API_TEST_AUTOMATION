...
public class Put_API_Tests {
	...
	@Test(description = "Validate that response code falls in 2XX category", priority = 1, groups = {"Regression"})
	...
	@Test(description = "Validate that response code = 200 ", priority = 2, groups = {"Functional"})
	...
	@Test(description = "Validate that value of the user gets updated post successfull updation ", priority = 4, groups = {"Regression"})
